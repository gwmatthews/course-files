...
output:
 pdf_document: 
  ...
  toc: no
  includes:
   in_header: syllabus-preamble.tex
 html_document:
  toc: no
---
...
As for cell phone use, attendance, participation and so on, this will be decided upon by the class as a whole in the first week of the semester.
